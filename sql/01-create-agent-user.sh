...
clickhouse-client -u default --password "$ADMIN_PASS" --param_agent_pass "$AGENT_PASS" --query "CREATE USER IF NOT EXISTS ghostslate_agent IDENTIFIED WITH sha256_password BY {agent_pass:String} SETTINGS readonly=1, max_execution_time=15, max_rows_to_read=1000000, max_bytes_to_read=200000000, max_memory_usage=268435456, max_result_rows=2000, max_result_bytes=20971520, max_threads=2;"
clickhouse-client -u default --password "$ADMIN_PASS" --query "ALTER USER ghostslate_agent SETTINGS readonly=1, max_execution_time=15, max_rows_to_read=1000000, max_bytes_to_read=200000000, max_memory_usage=268435456, max_result_rows=2000, max_result_bytes=20971520, max_threads=2;"
